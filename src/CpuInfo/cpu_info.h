...
struct CpuInfo
{
	...
	CPU_CLASS m_class;
	bool m_hybrid;
	unsigned short m_family, m_model, m_stepping, m_ext_model, m_ext_family;

	bool m_64, m_sse2, m_sse3, m_ssse3, m_sse41, m_sse42;

	bool m_avx, m_avx2, m_fma3, m_avx_vnni;
	bool m_aes;
	...
	bool m_amx_tile, m_amx_int8, m_amx_bf16;
